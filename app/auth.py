...
class Auth:
    ...
    def __init__(self):
        ...
        self.auth_token, self.bear_token = self.get_token()
    ...
    def get_token(self):
        ...
        # Capturing & String-Formatting Token Lifetime Information
            ...
            expires_at = parser.parse(self.fetched_at) + timedelta(seconds=self.auth_token['expires_in'])
        ...
        return self.auth_token, self.bear_token
    ...
    def validate(self):
        ...
        if self.not_expired():
            ...
            auth_header = {'Authorization': 'OAuth {}'.format(self.auth_token['access_token'])}
